...
export enum TReviewCustomState {
  /** Role tells that this channel can be used to track inventory entries.Channels with this role can be treated as warehouses */
  Pending = 'Pending',
  /** Role tells that this channel can be used to track order export activities. */
  Approved = 'Approved',
...
export type TFetchReviewDetailsQueryVariables = Exact<{
  reviewId: Scalars['String'];
}>;

export type TFetchReviewDetailsQuery = {
  __typename?: 'Query';
  review?: TReview
};

export type TUpdateReviewDetailsMutationVariables = Exact<{
  reviewId: Scalars['String'];
  version: Scalars['Long'];
  actions: Array<TReviewUpdateAction> | TReviewUpdateAction;
}>;

export type TUpdateReviewDetailsMutation = {
  __typename?: 'Mutation';
  updateReview?: {
    __typename?: 'Review';
    id: string;
